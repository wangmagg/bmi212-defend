...
if (!dir.exists('../data/diff_exp_output')) {
  dir.create('../data/diff_exp_output')
}
```
...
gabriel_expr_data <- read_excel('../data/diff_exp_input/GSE141549_batchCorrectednormalizedArrayscombined.xlsx')
```
...
```{r}
# hierarchically cluster expression data to see if there's normal/disease separation
tamaresis_dists <- dist(t(tamaresis_expr_data_input))
