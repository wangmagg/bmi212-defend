...
gabriel_top_genes_filt <- gabriel_top_genes |>
...
write.csv(gabriel_top_genes, 'res/GSE141549_all_genes.csv')
write.csv(gabriel_top_genes_filt, 'res/GSE141549_top_genes.csv')
```
...
tamaresis_top_genes_filt <- tamaresis_top_genes |>
  filter((abs(logFC) > 1.1 & adj.P.Val < 0.05))
...
write.csv(tamaresis_top_genes, 'res/GSE51981_all_genes.csv')
write.csv(tamaresis_top_genes_filt, 'res/GSE51981_top_genes.csv')
```
